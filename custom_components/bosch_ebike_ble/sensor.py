...
SENSOR_DESCRIPTIONS: dict[str, SensorEntityDescription] = {
    ...
    BoschEBikeSensor.TOTAL_DISTANCE: SensorEntityDescription(
        key=BoschEBikeSensor.TOTAL_DISTANCE,
    ...
    BoschEBikeSensor.WHEEL_CIRCUMFERENCE: SensorEntityDescription(
        key=BoschEBikeSensor.WHEEL_CIRCUMFERENCE,
        translation_key="wheel_circumference",
        native_unit_of_measurement="mm",
        icon="mdi:tire",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    BoschEBikeSensor.TOTAL_ENERGY: SensorEntityDescription(
        key=BoschEBikeSensor.TOTAL_ENERGY,
    ...
    BoschEBikeSensor.BATTERY_CAPACITY: SensorEntityDescription(
        key=BoschEBikeSensor.BATTERY_CAPACITY,
    ...
    BoschEBikeSensor.ENERGY_DELIVERED: SensorEntityDescription(
        key=BoschEBikeSensor.ENERGY_DELIVERED,
    ...
    BoschEBikeSensor.CHARGE_CYCLES: SensorEntityDescription(
        key=BoschEBikeSensor.CHARGE_CYCLES,
        translation_key="charge_cycles",
        icon="mdi:battery-sync",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    BoschEBikeSensor.MAX_ASSIST_SPEED: SensorEntityDescription(
        key=BoschEBikeSensor.MAX_ASSIST_SPEED,
